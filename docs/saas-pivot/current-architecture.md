...
Neon credential rotation is unverified and blocks production migration. Phase 3A and the bounded Phase 3B pilot are implemented and were committed on 2026-07-29. Phase 3A's guarded-local gate is closed; Phase 3B's automated/browser/restart/regression/cleanup evidence passed on 2026-07-22 and its owner-performed physical-keyboard acceptance passed on 2026-07-29, closing its guarded-local gate. No Phase 3C, public pilot, or production work is authorized.
